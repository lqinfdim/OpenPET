...
from openpet.utils.logging import get_logger
import importlib
from openpet.pet_configs import BasePETConfig
from openpet.basemodel import PETBase
...
class AutoPETConfig:
    ...
    def from_finetuned(cls, finetuned_delta_path, **kwargs):
        ...
        config_dict, kwargs = BasePETConfig.get_config_dict(finetuned_delta_path, **kwargs)
...
class AutoPETModel:
    ...
    @classmethod
    def from_config(cls, config, backbone_model, **kwargs) -> PETBase:
    ...
    @classmethod
    def from_finetuned(cls, finetuned_delta_path, backbone_model, *model_args, **kwargs) -> PETBase:
        ...
        if not isinstance(delta_config, BasePETConfig):
            delta_config, kwargs = AutoPETConfig.from_finetuned(
...
if __name__ == "__main__":
    ...
    delta_model = AutoPETModel.from_finetuned("ShengdingHu/autodelta_try", model, use_auth_token=True)
