...
from  openpet import __version__ as opendelta_version
from openpet.utils import logging
from openpet.utils.signature import get_arg_names, get_arg_names_inside_func
import transformers
import json
import copy
...
class BasePETConfig:
    ...
    def __init__(self,
        ...
        arg_names = get_arg_names(BasePETConfig.__init__)
    ...
    @classmethod
    def from_finetuned(cls, finetuned_delta_path: Union[str, os.PathLike], **kwargs) -> "BasePETConfig":
        r"""
    ...
    @classmethod
    def from_dict(cls, config_dict: Dict[str, Any], **kwargs) -> "BasePETConfig":
        r"""
        ...
        accept_args = get_arg_names(cls.__init__) + get_arg_names(BasePETConfig.__init__)
        unused_config_keys = []
    ...
    def to_diff_dict(self) -> Dict[str, Any]:
        ...
        default_config_dict = BasePETConfig().to_dict()
...
if __name__ == "__main__":
    myconfig = BasePETConfig.from_pretrained("../ckpts/lora/")
