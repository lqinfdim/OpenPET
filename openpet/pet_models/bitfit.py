...
from openpet.basemodel import PETBase, is_leaf_module
from openpet.utils.cuda import get_device, get_dtype
...
class BitFitConfig(BasePETConfig):
    r"""
