...
from openpet.pet_models.layers.low_rank_linear import LowRankLinear
from openpet.pet_models.layers.activations import Activations
from typing import Optional, Union
from openpet.utils.signature import get_arg_names_inside_func
...
import torch
import math
import openpet.utils.logging as logging
logger = logging.get_logger(__name__)


class LowRankAdapterConfig(BasePETConfig):
    r"""
...
class LowRankAdapterModel(PETBase):
    ...
    def __init__(self,
        ...
        self.add_all_pet_to_backbone(self.backbone_model,
