...
from openpet.utils.signature import get_arg_names_inside_func, signature
...
class PrefixConfig(BasePETConfig):
    def __init__(
        self,
        prefix_token_num=6,
        reparameterize=True,
...
class PrefixModel(PETBase):
    ...
    def new_module_like(self, module):
        ...
        elif isinstance(module, ViTAttention):
            module_device = get_device(module)
            prefixlayer = VPTLayerViT(prefix_token_num=self.prefix_token_num, num_heads=module.num_heads ,device=module_device)
        else:
